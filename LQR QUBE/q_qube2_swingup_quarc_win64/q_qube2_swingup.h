...
typedef struct {
  ...
  real_T u0V;                          /* '<Root>/+//-10V' */
  real_T Sum;                          /* '<S1>/Sum' */
  real_T Sum3[4];                      /* '<Root>/Sum3' */
  real_T ForveCCW;                     /* '<S3>/For +ve CCW' */
  uint8_T AND;                         /* '<S2>/AND' */
} B_q_qube2_swingup_T;
...
struct P_q_qube2_swingup_T_ {
  ...
  real_T Step2_YFinal;                 /* Expression: 1
                                        * Referenced by: '<Root>/Step2'
                                        */
  real_T SetpointStateXd2_Value[4];    /* Expression: [pi/2 0 0 0]
  ...
  real_T Step1_YFinal;                 /* Expression: 1
                                        * Referenced by: '<Root>/Step1'
                                        */
  real_T SetpointStateXd1_Value[4];    /* Expression: [pi/4 0 0 0]
 ...
 * '<S2>'   : 'q_qube2_swingup/Interval Test'
 * '<S3>'   : 'q_qube2_swingup/Rotary Pendulum Interface'
 * '<S4>'   : 'q_qube2_swingup/Swing-Up Controller'
 * '<S5>'   : 'q_qube2_swingup/Rotary Pendulum Interface/Counts to Angles'
 * '<S6>'   : 'q_qube2_swingup/Rotary Pendulum Interface/State X'
 * '<S7>'   : 'q_qube2_swingup/Rotary Pendulum Interface/State X/Full Angle to Inverted'
 * '<S8>'   : 'q_qube2_swingup/Swing-Up Controller/Swing-Up Controller'
 */

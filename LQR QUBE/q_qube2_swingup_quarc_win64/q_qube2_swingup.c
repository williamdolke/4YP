...
void q_qube2_swingup_output(void)
{
  ...
  real_T rtb_Transpose1;
  real_T rtb_alpha_dot;
  real_T tmp;
  real_T tmp_0;
  int32_T i;
  ...
  rtb_Transpose1 = q_qube2_swingup_P.theta_dot_C *
    q_qube2_swingup_X.theta_dot_CSTATE + q_qube2_swingup_P.theta_dot_D *
    q_qube2_swingup_B.Armcountstorad;

  /* Bias: '<Root>/Bias2' */
  rtb_VectorConcatenate[2] = rtb_Transpose1 + q_qube2_swingup_P.Bias2_Bias;

  /* TransferFcn: '<S6>/alpha_dot' */
  rtb_alpha_dot = q_qube2_swingup_P.alpha_dot_C *
    q_qube2_swingup_X.alpha_dot_CSTATE + q_qube2_swingup_P.alpha_dot_D *
    q_qube2_swingup_B.Pendulumcountstorad;

  /* SignalConversion generated from: '<Root>/Vector Concatenate' */
  rtb_VectorConcatenate[3] = rtb_alpha_dot;

  /* Step: '<Root>/Step2' incorporates:
   *  Step: '<Root>/Step'
   *  Step: '<Root>/Step1'
   */
  tmp_0 = q_qube2_swingup_M->Timing.t[0];
  if (tmp_0 < q_qube2_swingup_P.Step2_Time) {
    rtb_MatrixMultiply3 = q_qube2_swingup_P.Step2_Y0;
  } else {
    rtb_MatrixMultiply3 = q_qube2_swingup_P.Step2_YFinal;
  }

  /* End of Step: '<Root>/Step2' */

  /* Product: '<Root>/Product1' incorporates:
   *  Constant: '<Root>/Setpoint State: Xd2'
   */
  rtb_Product1_idx_0 = rtb_MatrixMultiply3 *
    q_qube2_swingup_P.SetpointStateXd2_Value[0];
  rtb_Product1_idx_1 = rtb_MatrixMultiply3 *
    q_qube2_swingup_P.SetpointStateXd2_Value[1];
  rtb_Product1_idx_2 = rtb_MatrixMultiply3 *
    q_qube2_swingup_P.SetpointStateXd2_Value[2];
  rtb_Product1_idx_3 = rtb_MatrixMultiply3 *
    q_qube2_swingup_P.SetpointStateXd2_Value[3];

  /* Step: '<Root>/Step1' */
  if (tmp_0 < q_qube2_swingup_P.Step1_Time) {
    rtb_MatrixMultiply3 = q_qube2_swingup_P.Step1_Y0;
  } else {
    rtb_MatrixMultiply3 = q_qube2_swingup_P.Step1_YFinal;
  }

  /* Product: '<Root>/Product' incorporates:
   *  Constant: '<Root>/Setpoint State: Xd1'
   */
  rtb_Product = rtb_MatrixMultiply3 * q_qube2_swingup_P.SetpointStateXd1_Value[0];
   ...
   *  Sum: '<Root>/Sum2'
   */
  tmp = (((rtb_Product + q_qube2_swingup_P.SetpointStateXd_Value[0]) -
          q_qube2_swingup_B.Armcountstorad) - rtb_Product1_idx_0) *
    q_qube2_swingup_P.K_unstable[0];

  /* Product: '<Root>/Product' incorporates:
   *  Constant: '<Root>/Setpoint State: Xd1'
   */
  rtb_Product_idx_0 = rtb_Product;
  rtb_Product = rtb_MatrixMultiply3 * q_qube2_swingup_P.SetpointStateXd1_Value[1];
   ...
   *  Sum: '<Root>/Sum2'
   */
  tmp += (((rtb_Product + q_qube2_swingup_P.SetpointStateXd_Value[1]) -
           q_qube2_swingup_B.Bias) - rtb_Product1_idx_1) *
    q_qube2_swingup_P.K_unstable[1];

  /* Product: '<Root>/Product' incorporates:
   *  Constant: '<Root>/Setpoint State: Xd1'
   */
  rtb_Product_idx_1 = rtb_Product;
  rtb_Product = rtb_MatrixMultiply3 * q_qube2_swingup_P.SetpointStateXd1_Value[2];
   ...
   *  Sum: '<Root>/Sum2'
   */
  tmp += (((rtb_Product + q_qube2_swingup_P.SetpointStateXd_Value[2]) -
           rtb_Transpose1) - rtb_Product1_idx_2) * q_qube2_swingup_P.K_unstable
    [2];

  /* Product: '<Root>/Product' incorporates:
   *  Constant: '<Root>/Setpoint State: Xd1'
   */
  rtb_Product_idx_2 = rtb_Product;
  rtb_Product = rtb_MatrixMultiply3 * q_qube2_swingup_P.SetpointStateXd1_Value[3];
   ...
   *  Sum: '<Root>/Sum2'
   */
  q_qube2_swingup_B.uKx = (((rtb_Product +
    q_qube2_swingup_P.SetpointStateXd_Value[3]) - rtb_alpha_dot) -
    rtb_Product1_idx_3) * q_qube2_swingup_P.K_unstable[3] + tmp;
  if (rtmIsMajorTimeStep(q_qube2_swingup_M)) {
     ...
     */
    q_qube2_swingup_B.AND = (uint8_T)((q_qube2_swingup_P.IntervalTest_lowlimit <=
      q_qube2_swingup_B.Bias) && (q_qube2_swingup_B.Bias <=
   ...
   *  Gain: '<Root>/Gain'
   *  MATLAB Function: '<S4>/Swing-Up Controller'
   *  Sum: '<Root>/Sum'
   */
  if (q_qube2_swingup_B.AND > q_qube2_swingup_P.Switch_Threshold) {
    rtb_MatrixMultiply3 = q_qube2_swingup_B.uKx;
  } else {
    /* MATLAB Function: '<S4>/Swing-Up Controller' */
    rtb_Transpose1 = cos(q_qube2_swingup_B.Pendulumcountstorad);
    rtb_MatrixMultiply3 = rtb_alpha_dot * rtb_Transpose1;
    if (rtb_MatrixMultiply3 < 0.0) {
      rtb_MatrixMultiply3 = -1.0;
    } else if (rtb_MatrixMultiply3 > 0.0) {
      rtb_MatrixMultiply3 = 1.0;
    } else if (rtb_MatrixMultiply3 == 0.0) {
      rtb_MatrixMultiply3 = 0.0;
    } else {
      rtb_MatrixMultiply3 = (rtNaN);
    }

    /* Step: '<Root>/Step' */
    if (tmp_0 < q_qube2_swingup_P.Step_Time) {
      tmp_0 = q_qube2_swingup_P.Step_Y0;
    } else {
      tmp_0 = q_qube2_swingup_P.Step_YFinal;
    }

    rtb_MatrixMultiply3 = ((q_qube2_swingup_P.mp * q_qube2_swingup_P.g *
      q_qube2_swingup_P.l * (1.0 - rtb_Transpose1) + 0.5 * q_qube2_swingup_P.Jp *
      (rtb_alpha_dot * rtb_alpha_dot)) - q_qube2_swingup_P.E_r) *
      q_qube2_swingup_P.k_e * rtb_MatrixMultiply3 * (q_qube2_swingup_P.mr *
      q_qube2_swingup_P.r * q_qube2_swingup_P.a_max) * (q_qube2_swingup_P.Rm /
      q_qube2_swingup_P.km) + tmp_0;
  }

  /* End of Switch: '<Root>/Switch' */

  /* Saturate: '<Root>/+//-10V' */
  if (rtb_MatrixMultiply3 > q_qube2_swingup_P.u0V_UpperSat) {
    /* Saturate: '<Root>/+//-10V' */
    q_qube2_swingup_B.u0V = q_qube2_swingup_P.u0V_UpperSat;
  } else if (rtb_MatrixMultiply3 < q_qube2_swingup_P.u0V_LowerSat) {
    /* Saturate: '<Root>/+//-10V' */
    q_qube2_swingup_B.u0V = q_qube2_swingup_P.u0V_LowerSat;
  } else {
    /* Saturate: '<Root>/+//-10V' */
    q_qube2_swingup_B.u0V = rtb_MatrixMultiply3;
  }

  /* End of Saturate: '<Root>/+//-10V' */

  /* Gain: '<Root>/Gain1' */
  rtb_MatrixMultiply3 = q_qube2_swingup_P.km / q_qube2_swingup_P.Rm *
  ...
  for (i = 0; i < 4; i++) {
     ...
     *  SignalConversion generated from: '<Root>/Vector Concatenate'
     * */
    rtb_Transpose1 += rtb_VectorConcatenate[i] * (q_qube2_swingup_P.Q[i + 12] *
      rtb_alpha_dot + (q_qube2_swingup_P.Q[i + 8] * rtb_VectorConcatenate[2] +
                       (q_qube2_swingup_P.Q[i + 4] * q_qube2_swingup_B.Bias +
                        q_qube2_swingup_P.Q[i] *
                        q_qube2_swingup_B.Armcountstorad)));
  }
   ...
   */
  q_qube2_swingup_B.Sum = q_qube2_swingup_P.R * rtb_MatrixMultiply3 *
    rtb_MatrixMultiply3 + rtb_Transpose1;
  if (rtmIsMajorTimeStep(q_qube2_swingup_M)) {
  }
   ...
   *  Constant: '<Root>/Setpoint State: Xd'
   */
  q_qube2_swingup_B.Sum3[0] = (q_qube2_swingup_P.SetpointStateXd_Value[0] -
    rtb_Product1_idx_0) + rtb_Product_idx_0;
  q_qube2_swingup_B.Sum3[1] = (q_qube2_swingup_P.SetpointStateXd_Value[1] -
    rtb_Product1_idx_1) + rtb_Product_idx_1;
  q_qube2_swingup_B.Sum3[2] = (q_qube2_swingup_P.SetpointStateXd_Value[2] -
    rtb_Product1_idx_2) + rtb_Product_idx_2;
  q_qube2_swingup_B.Sum3[3] = (q_qube2_swingup_P.SetpointStateXd_Value[3] -
    rtb_Product1_idx_3) + rtb_Product;
  if (rtmIsMajorTimeStep(q_qube2_swingup_M)) {
  }
...
RT_MODEL_q_qube2_swingup_T *q_qube2_swingup(void)
{
  ...
  rtmSetTFinal(q_qube2_swingup_M, 50.0);
  q_qube2_swingup_M->Timing.stepSize0 = 0.002;
  q_qube2_swingup_M->Timing.stepSize1 = 0.002;

  /* External mode info */
  q_qube2_swingup_M->Sizes.checksums[0] = (1029298406U);
  q_qube2_swingup_M->Sizes.checksums[1] = (2248110715U);
  q_qube2_swingup_M->Sizes.checksums[2] = (2740498438U);
  q_qube2_swingup_M->Sizes.checksums[3] = (3798331014U);
  ...
  q_qube2_swingup_M->Sizes.numBlocks = (68);/* Number of blocks */
  q_qube2_swingup_M->Sizes.numBlockIO = (10);/* Number of block outputs */
  q_qube2_swingup_M->Sizes.numBlockPrms = (127);/* Sum of parameter "widths" */

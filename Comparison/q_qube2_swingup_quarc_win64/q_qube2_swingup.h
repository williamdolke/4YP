...
typedef struct {
  real_T Pendulumcountstorad;          /* '<S2>/Pendulum:  counts to rad' */
  real_T Bias;                         /* '<S4>/Bias' */
  real_T Armcountstorad;               /* '<S2>/Arm: counts to rad' */
  real_T u0V;                          /* '<Root>/+//-10V' */
  real_T ForveCCW;                     /* '<S1>/For +ve CCW' */
} B_q_qube2_swingup_T;
...
typedef struct {
  real_T alpha_dot_CSTATE;             /* '<S3>/alpha_dot' */
...
/* State disabled  */
typedef struct {
  boolean_T alpha_dot_CSTATE;          /* '<S3>/alpha_dot' */
...
struct P_q_qube2_swingup_T_ {
  ...
  real_T SineWave_Bias;                /* Expression: 0
                                        * Referenced by: '<Root>/Sine Wave'
                                        */
  real_T SineWave_Freq;                /* Expression: 20
                                        * Referenced by: '<Root>/Sine Wave'
                                        */
 ...
 * '<S1>'   : 'q_qube2_swingup/Rotary Pendulum Interface'
 * '<S2>'   : 'q_qube2_swingup/Rotary Pendulum Interface/Counts to Angles'
 * '<S3>'   : 'q_qube2_swingup/Rotary Pendulum Interface/State X'
 * '<S4>'   : 'q_qube2_swingup/Rotary Pendulum Interface/State X/Full Angle to Inverted'
 */

  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% q_qube2_swingup_B.MatrixMultiply3
	  section.data(8).logicalSrcIdx = 7;
	  section.data(8).dtTransOffset = 7;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% q_qube2_swingup_DW.Scope1_PWORK_g.LoggedData
	  section.data(5).logicalSrcIdx = 8;
	  section.data(5).dtTransOffset = 4;
	
	  ;% q_qube2_swingup_DW.Scope2_PWORK_j.LoggedData
	  ...
	  ;% q_qube2_swingup_DW.Scope1_PWORK_i.LoggedData
	  section.data(11).logicalSrcIdx = 14;
	  section.data(11).dtTransOffset = 10;
	
	  ;% q_qube2_swingup_DW.Scope2_PWORK_i.LoggedData
	  section.data(12).logicalSrcIdx = 15;
	  section.data(12).dtTransOffset = 11;
	
	  ;% q_qube2_swingup_DW.Scope3_PWORK_g.LoggedData
  ...
  targMap.checksum0 = 311290339;
  targMap.checksum1 = 678029373;
  targMap.checksum2 = 1168732278;
  targMap.checksum3 = 489994301;

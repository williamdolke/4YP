...
typedef struct {
  real_T Memory[12288];                /* '<Root>/Memory' */
  real_T Delay;                        /* '<Root>/Delay' */
  real_T u0V;                          /* '<Root>/+//-10V' */
  real_T Armcountstorad;               /* '<S4>/Arm: counts to rad' */
  real_T theta_dot;                    /* '<S5>/theta_dot' */
  real_T RateTransition;               /* '<S5>/Rate Transition' */
  real_T Pendulumcountstorad;          /* '<S4>/Pendulum:  counts to rad' */
  real_T alpha_dot;                    /* '<S5>/alpha_dot' */
  real_T RateTransition1;              /* '<S5>/Rate Transition1' */
  real_T Bias2;                        /* '<S3>/Bias2' */
  real_T Bias1;                        /* '<S3>/Bias1' */
  real_T Add;                          /* '<S6>/Add' */
  real_T CumulativeSum;                /* '<S3>/Cumulative Sum' */
  real_T action;                       /* '<Root>/MATLAB Function' */
  real_T Q[12288];                     /* '<Root>/MATLAB Function' */
  real_T discreteState[4];             /* '<Root>/MATLAB Function' */
  real_T maxQ;                         /* '<Root>/MATLAB Function' */
  real_T maxIndex;                     /* '<Root>/MATLAB Function' */
  uint8_T Gain6;                       /* '<S7>/Gain6' */
} B_q_qube2_swingup_T;
...
typedef struct {
  ...
  real_T Memory_PreviousInput[12288];  /* '<Root>/Memory' */
  ...
  real_T CumulativeSum_RunningCumVal;  /* '<S3>/Cumulative Sum' */
  ...
  uint32_T state_n[2];                 /* '<Root>/MATLAB Function' */
  uint32_T state_m[625];               /* '<Root>/MATLAB Function' */
} DW_q_qube2_swingup_T;

/* Continuous states (default storage) */
typedef struct {
  real_T theta_dot_CSTATE;             /* '<S5>/theta_dot' */
  real_T alpha_dot_CSTATE;             /* '<S5>/alpha_dot' */
} X_q_qube2_swingup_T;
...
/* State disabled  */
typedef struct {
  boolean_T theta_dot_CSTATE;          /* '<S5>/theta_dot' */
  boolean_T alpha_dot_CSTATE;          /* '<S5>/alpha_dot' */
...
struct P_q_qube2_swingup_T_ {
  real_T Q_init[12288];                /* Variable: Q_init
                                        * Referenced by: '<Root>/Memory'
                                        */
  real_T actInfo[3];                   /* Variable: actInfo
                                        * Referenced by: '<Root>/Constant'
                                        */
  real_T buckets;                      /* Variable: buckets
                                        * Referenced by: '<Root>/Constant2'
                                        */
  real_T episode;                      /* Variable: episode
  ...
  real_T Constant1_Value;              /* Expression: 0
                                        ...
                                        */
  real_T Memory2_InitialCondition[4];  /* Expression: [5 5 5 5]'
 ...
 * '<S1>'   : 'q_qube2_swingup/MATLAB Function'
 * '<S2>'   : 'q_qube2_swingup/Rotary Pendulum Interface'
 * '<S3>'   : 'q_qube2_swingup/calculate reward'
 * '<S4>'   : 'q_qube2_swingup/Rotary Pendulum Interface/Counts to Angles'
 * '<S5>'   : 'q_qube2_swingup/Rotary Pendulum Interface/State X'
 * '<S6>'   : 'q_qube2_swingup/calculate reward/cost_function'
 * '<S7>'   : 'q_qube2_swingup/calculate reward/success_reward'
 */

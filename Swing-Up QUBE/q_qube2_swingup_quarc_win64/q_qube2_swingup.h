...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } InvertedPendulumrad_PWORK;         /* '<Root>/Inverted Pendulum (rad)' */

  struct {
    void *LoggedData;
  } Pendulumrad_PWORK;                 /* '<Root>/Pendulum (rad)' */

  struct {
    void *LoggedData;
  } RotaryArmrad_PWORK;                /* '<Root>/Rotary Arm (rad)' */
...
struct P_q_qube2_swingup_T_ {
  real_T E_r;                          /* Variable: E_r
                                        * Referenced by: '<S3>/Constant2'
                                        */
  real_T Jp;                           /* Variable: Jp
                                        * Referenced by: '<S3>/Constant7'
                                        */
  real_T K_unstable[4];                /* Variable: K_unstable
 ...
 * '<S1>'   : 'q_qube2_swingup/Interval Test'
 * '<S2>'   : 'q_qube2_swingup/Rotary Pendulum Interface'
 * '<S3>'   : 'q_qube2_swingup/Swing-Up Controller'
 * '<S4>'   : 'q_qube2_swingup/Rotary Pendulum Interface/Counts to Angles'
 * '<S5>'   : 'q_qube2_swingup/Rotary Pendulum Interface/State X'
 * '<S6>'   : 'q_qube2_swingup/Rotary Pendulum Interface/State X/Full Angle to Inverted'
 * '<S7>'   : 'q_qube2_swingup/Swing-Up Controller/Swing-Up Controller'
 */

...
void q_qube2_swingup_output(void)
{
  ...
  if (rtmIsMajorTimeStep(q_qube2_swingup_M)) {
     ...
     *  RelationalOperator: '<S1>/Lower Test'
     *  RelationalOperator: '<S1>/Upper Test'
     */
   ...
   */
  q_qube2_swingup_B.uKx = ((q_qube2_swingup_P.SetpointStateXd_Value[2] -
    (q_qube2_swingup_P.theta_dot_C * q_qube2_swingup_X.theta_dot_CSTATE +
     q_qube2_swingup_P.theta_dot_D * q_qube2_swingup_B.Armcountstorad)) *
    q_qube2_swingup_P.K_unstable[2] + ((q_qube2_swingup_P.SetpointStateXd_Value
    [0] - q_qube2_swingup_B.Armcountstorad) * q_qube2_swingup_P.K_unstable[0] +
    (q_qube2_swingup_P.SetpointStateXd_Value[1] - q_qube2_swingup_B.Bias) *
    q_qube2_swingup_P.K_unstable[1])) +
    (q_qube2_swingup_P.SetpointStateXd_Value[3] - rtb_alpha_dot) *
    q_qube2_swingup_P.K_unstable[3];
  if (rtmIsMajorTimeStep(q_qube2_swingup_M)) {
  }
   ...
   *  Gain: '<Root>/Gain'
   *  MATLAB Function: '<S3>/Swing-Up Controller'
   *  Sum: '<Root>/Sum'
   */
  if (q_qube2_swingup_B.AND > q_qube2_swingup_P.Switch_Threshold) {
    rtb_Switch = q_qube2_swingup_B.uKx;
  } else {
    /* MATLAB Function: '<S3>/Swing-Up Controller' */
    rtb_Switch = cos(q_qube2_swingup_B.Pendulumcountstorad);
    u = rtb_alpha_dot * rtb_Switch;
    if (u < 0.0) {
      u = -1.0;
    } else if (u > 0.0) {
      u = 1.0;
    ...
    /* Step: '<Root>/Step' */
    if (q_qube2_swingup_M->Timing.t[0] < q_qube2_swingup_P.Step_Time) {
    ...
    rtb_Switch = ((q_qube2_swingup_P.mp * q_qube2_swingup_P.g *
                   q_qube2_swingup_P.l * (1.0 - rtb_Switch) + 0.5 *
                   q_qube2_swingup_P.Jp * (rtb_alpha_dot * rtb_alpha_dot)) -
                  q_qube2_swingup_P.E_r) * q_qube2_swingup_P.k_e * u *
      (q_qube2_swingup_P.mr * q_qube2_swingup_P.r * q_qube2_swingup_P.a_max) *
      (q_qube2_swingup_P.Rm / q_qube2_swingup_P.km) + tmp;
  }

  /* End of Switch: '<Root>/Switch' */

  /* Saturate: '<Root>/+//-10V' */
  if (rtb_Switch > q_qube2_swingup_P.u0V_UpperSat) {
    /* Saturate: '<Root>/+//-10V' */
    q_qube2_swingup_B.u0V = q_qube2_swingup_P.u0V_UpperSat;
  } else if (rtb_Switch < q_qube2_swingup_P.u0V_LowerSat) {
    /* Saturate: '<Root>/+//-10V' */
    q_qube2_swingup_B.u0V = q_qube2_swingup_P.u0V_LowerSat;
  } else {
    /* Saturate: '<Root>/+//-10V' */
    q_qube2_swingup_B.u0V = rtb_Switch;
  }
...
RT_MODEL_q_qube2_swingup_T *q_qube2_swingup(void)
{
  ...
  /* External mode info */
  q_qube2_swingup_M->Sizes.checksums[0] = (2414814897U);
  q_qube2_swingup_M->Sizes.checksums[1] = (648599843U);
  q_qube2_swingup_M->Sizes.checksums[2] = (1297179145U);
  q_qube2_swingup_M->Sizes.checksums[3] = (2001136932U);
  ...
  q_qube2_swingup_M->Sizes.numBlocks = (42);/* Number of blocks */
  q_qube2_swingup_M->Sizes.numBlockIO = (7);/* Number of block outputs */
  q_qube2_swingup_M->Sizes.numBlockPrms = (94);/* Sum of parameter "widths" */

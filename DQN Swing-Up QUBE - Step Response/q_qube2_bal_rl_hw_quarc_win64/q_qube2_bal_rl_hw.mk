###########################################################################
## Makefile generated for component 'q_qube2_bal_rl_hw'. 
## 
## Makefile     : q_qube2_bal_rl_hw.mk
## Generated on : Fri Mar 11 15:34:55 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\q_qube2_bal_rl_hw.rt-win64
...
PRODUCT_NAME              = q_qube2_bal_rl_hw
MAKEFILE                  = q_qube2_bal_rl_hw.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2021a
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2021a\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\magd4814\ONEDRI~1\4YP\SIMULA~1\QUBE\RLDQNS~2
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = q_qube2_bal_rl_hw_comp.rsp
CMD_FILE                  = q_qube2_bal_rl_hw.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\q_qube2_bal_rl_hw.rt-win64
...
DEFINES_STANDARD = -DMODEL=q_qube2_bal_rl_hw -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\q_qube2_bal_rl_hw_quarc_win64\q_qube2_bal_rl_hw.c $(START_DIR)\q_qube2_bal_rl_hw_quarc_win64\q_qube2_bal_rl_hw_data.c $(START_DIR)\q_qube2_bal_rl_hw_quarc_win64\q_qube2_bal_rl_hw_main.c $(START_DIR)\q_qube2_bal_rl_hw_quarc_win64\rtGetInf.c $(START_DIR)\q_qube2_bal_rl_hw_quarc_win64\rtGetNaN.c $(START_DIR)\q_qube2_bal_rl_hw_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = q_qube2_bal_rl_hw.obj q_qube2_bal_rl_hw_data.obj q_qube2_bal_rl_hw_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\q_qube2_bal_rl_hw_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\q_qube2_bal_rl_hw_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
q_qube2_bal_rl_hw.obj : $(START_DIR)\q_qube2_bal_rl_hw_quarc_win64\q_qube2_bal_rl_hw.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_qube2_bal_rl_hw_quarc_win64\q_qube2_bal_rl_hw.c


q_qube2_bal_rl_hw_data.obj : $(START_DIR)\q_qube2_bal_rl_hw_quarc_win64\q_qube2_bal_rl_hw_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_qube2_bal_rl_hw_quarc_win64\q_qube2_bal_rl_hw_data.c


q_qube2_bal_rl_hw_main.obj : $(START_DIR)\q_qube2_bal_rl_hw_quarc_win64\q_qube2_bal_rl_hw_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_qube2_bal_rl_hw_quarc_win64\q_qube2_bal_rl_hw_main.c


rtGetInf.obj : $(START_DIR)\q_qube2_bal_rl_hw_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_qube2_bal_rl_hw_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\q_qube2_bal_rl_hw_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_qube2_bal_rl_hw_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\q_qube2_bal_rl_hw_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\q_qube2_bal_rl_hw_quarc_win64\rt_nonfinite.c
